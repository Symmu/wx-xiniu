...
Page({
  data:{
    ...
    gameOfPlay:'',
    //用户选择的图片
    imageUserScr:'../../../images/image/wenhao.png',
    //电脑随机的图片
    imageAiScr:'',
    //石头剪刀布图片数组
    srcs:[
      '../../../images/image/shitou.png',
      '../../../images/image/jiandao.png',
      '../../../images/image/bu.png'
    ]
  },
  ...
  changeForChoose(e){
    console.log();
      ...
      //判断是否获胜
      if( user == "../../../images/image/shitou.png" && ai == "../../../images/image/jiandao.png"){
         //获胜后增加次数、改变文字内容、从新缓存获胜次数
         num++;
         str = 'Ho~\nYou Win!';
         wx.setStorageSync('winNum', num);
      };
      if(user == "../../../images/image/jiandao.png" && ai == "../../../images/image/bu.png"){
         num++;
         str = 'Ho~\nYou Win!';
         wx.setStorageSync('winNum', num);
      };
      if(user== "../../../images/image/bu.png" && ai == "../../../images/image/shitou.png"){
         num++;
         str = 'Ho~\nYou Win!';
         wx.setStorageSync('winNum', num);
      };
